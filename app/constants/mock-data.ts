...
export const SERVICES: ServicesData = {
  ...
  medicure: Array(6).fill({ name: 'Perfectly Polished', description: 'Làm mới màu sắc (Mani hoặc Pedi)...', price: '390k' }).map((item, index) => ({ ...item, id: index + 1 })),
  pedicure: Array(4).fill({ name: 'Perfectly Polished', description: 'Làm mới màu sắc (Mani hoặc Pedi)...', price: '390k' }).map((item, index) => ({ ...item, id: index + 1 })),
  effect: Array(6).fill({ name: 'Perfectly Polished', description: 'Làm mới màu sắc (Mani hoặc Pedi)...', price: '390k' }).map((item, index) => ({ ...item, id: index + 1 })),
  drink: [
