    ...
    <div className='w-full min-h-screen flex flex-col'>
      ...
      <div className='relative w-full min-h-screen flex flex-col'>
        ...
        <div
          ...
          style={{
            background:
              'linear-gradient(180deg, rgba(0,0,0,0.3) 0%, rgba(94, 60, 3, 0.85) 35%, #614F38 60%, #614F38 100%)'
          }}
        />
          ...
          >
            <div className='w-full flex justify-between items-center mb-4'>
              ...
              <button
                ...
                className='flex items-center gap-3 bg-[#8B5704] hover:bg-[#734903] mb-10 text-white px-3 py-1.5 transition-all duration-300 shadow-sm'
              >
                <ShoppingCart size={20} strokeWidth={2} />
                <span className='text-[16px] font-medium uppercase leading-[1.5] tracking-normal'>{t('cart')}</span>
                <span className='bg-[#F5F5F0] text-[#333] rounded-full w-6 h-6 flex items-center justify-center text-[14px] font-bold'>
                  {cartCount}
                </span>
              </button>
            </div>
            ...
            <div className='w-full max-w-7xl pb-32'>
              ...
              >
                ...
                <div className='order-1 lg:order-2'>
                  <h2 className='text-4xl md:text-5xl font-serif text-[#E1C084] font-light mb-10'>
                    {t('combo_package_title')}
                  </h2>
                    ...
                    {SERVICES.combo.map((service, index) => (
                      ...
                      >
                        <div className='flex-1'>
                          <h3 className='text-white text-lg font-semibold mb-1 group-hover:text-[#FCE48C] transition-colors'>
                            {service.name}
                          </h3>
              ...
              >
                ...
                <div className='order-1 lg:order-2'>
                  <h2 className='text-4xl md:text-5xl font-serif text-[#E1C084] font-light mb-7'>
                    {t('drinks_title')}
                  </h2>
                  <div className='space-y-1'>
          ...
          <div className='grid grid-cols-3 gap-8 items-end'>
            {[-1, 0, 1].map((offset) => {
              ...
              return (
                ...
                >
                  <div
                    className={`relative w-full overflow-hidden shadow-2xl ${isCenter ? 'h-[580px]' : 'h-[480px] mt-[50px]'}`}
                  >
                  ...
                  <div className='px-4 py-4'>
                    ...
                    <button className='text-[#E1C084]/70 text-sm mt-2 hover:text-[#E1C084] transition underline underline-offset-2'>
                      {t('read_more')}
                    </button>
                  </div>
                </div>
              ...
              >
                ...
                <span
                  style={{
                    ...
                    height: '6px',
                    borderRadius: '50%',
                    backgroundColor: activeTestimonial === i ? '#DAD3CA' : 'rgba(255,255,255,0.5)'
                  }}
                />
              </button>
            ))}
      ...
      <div className='relative w-full flex items-center justify-center text-center overflow-hidden min-h-[420px]'>
        <div className='absolute inset-0 bg-cover bg-center' style={{ backgroundImage: "url('/booking.png')" }} />
